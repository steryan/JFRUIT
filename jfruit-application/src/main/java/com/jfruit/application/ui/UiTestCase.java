...
public class UiTestCase extends BaseTestCaseUi {
	...
	static Logger logger = LogManager.getLogger(UiTestCase.class.getName());

	/**
	 * Open google.com and Enter a search string in the text box Click the
	 * search button Verify the title of the loaded page
	 * 
	 * @author Stephen Ryan
	 */
	@Test
